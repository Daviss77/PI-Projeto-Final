...
public class InfoRemedios {
       /* String dipInf = "Cartela de 10 comprimidos.\nModo de uso: Via oral, a cada 8 horas.\nTarja: Amarela.  \n500 Mg.\nGenérico do Dipirona: Novalgina.";
        ...
        cimegripe.dosagem = "1 cápsula a cada 4 horas.";
        cimegripe.modoDeUSo = "NÃO USE ESTE MEDICAMENTO EM CASO DE DOENÇAS DO CORAÇÃO, PRESSÃO ALTA E GLAUCOMA. NÃO USE JUNTO COM OUTROS MEDICAMENTOS QUE CONTENHAM PARACETAMOL, COM ÁLCOOL, OU EM CASO DE DOENÇA GRAVE DO FÍGADO. DURANTE SEU USO, NÃO DIRIJA OU OPERE MÁQUINAS, POIS SUA AGILIDADE E ATENÇÃO PODEM ESTAR PREJUDICADAS";
